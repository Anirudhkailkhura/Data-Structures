...
void insertAtPosition(Node *&head, int val, int pos)
{
    ...
    // updating the next part of the new node
    new_node->next = temp->next;

    // updating the next part of the previous node
    temp->next = new_node;
}
...
void updatePosition(Node *&head, int k, int val)
{
    ...
    // temp will be pointing at the kth position
...
void deleteAtTail(Node *&head)
{
    ...
    // now second_last point at the second last position
